...
ax1.set_title('Negative IMF By, high driving, '+hemi)
...
ax21.text(61, histscale-60, 'Width: %4.2f' % (medianpol-medianeq))
ax21.text(61, histscale-80, 'Substorms: %4i' % noaa.substorm[use].sum())
ax21.text(61, histscale-100, '# =  %4i' % sum(use))
ax21.text(61, histscale-120, 'substorm ratio =  %4.2f' % (1.*noaa.substorm[use].sum()/sum(use)))                    
ax21.set_title('Negative IMF By, high driving, '+hemi)
...
ax2.set_title('Positive IMF By, high driving, '+hemi)
...
ax22.text(61, histscale-60, 'Width: %4.2f' % (medianpol-medianeq))
ax22.text(61, histscale-80, 'Substorms: %4i' % noaa.substorm[use].sum())
ax22.text(61, histscale-100, '# =  %4i' % sum(use))
ax22.text(61, histscale-120, 'substorm ratio =  %4.2f' % (1.*noaa.substorm[use].sum()/sum(use)))                    
ax22.set_title('Positive IMF By, high driving, '+hemi)
...
ax3.set_title('Negative IMF By, low driving, '+hemi)
...
ax23.text(61, histscale-60, 'Width: %4.2f' % (medianpol-medianeq))
ax23.text(61, histscale-80, 'Substorms: %4i' % noaa.substorm[use].sum())
ax23.text(61, histscale-100, '# =  %4i' % sum(use))
ax23.text(61, histscale-120, 'substorm ratio =  %4.2f' % (1.*noaa.substorm[use].sum()/sum(use)))          
ax23.set_title('Negative IMF By, low driving, '+hemi)
...
ax4.set_title('Positive IMF By, low driving, '+hemi)
...
ax24.text(61, histscale-60, 'Width: %4.2f' % (medianpol-medianeq))
ax24.text(61, histscale-80, 'Substorm: %4i' % noaa.substorm[use].sum())
ax24.text(61, histscale-100, '# =  %4i' % sum(use))
ax24.text(61, histscale-120, 'substorm ratio =  %4.2f' % (1.*noaa.substorm[use].sum()/sum(use)))          
ax24.set_title('Positive IMF By, low driving, '+hemi)
